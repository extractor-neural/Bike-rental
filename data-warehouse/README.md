...
This contains 2 files: Bike sharing counts aggregated on hourly basis (hour.csv - 17379 rows, 17 pa.Columns) & bike sharing counts aggregated on daily basis (day.csv - 731 rows, 16 pa.Columns)
...
Feel free to explore the data set with multiple **supervised** and **unsupervised** learning techniques. The Following data dictionary gives more details on this data set. All pa.Columns (except hr) are similar in both the data sets:

---

### Data Dictionary 

| pa.Column   Position 	| Atrribute Name 	| Definition                                                                                                                                                                                                                                                                                                 	| Data Type    	| Example                            	| % Null Ratios 	|
|-------------------	|----------------	|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------	|--------------	|------------------------------------	|---------------	|
